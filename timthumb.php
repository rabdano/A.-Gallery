...
define ('MAX_WIDTH', 4320);					// maximum image width
define ('MAX_HEIGHT', 3240);				// maximum image height
...
define ('MAX_FILE_SIZE', 5000000);			// file size limit to prevent possible DOS attacks (roughly 1.5 megabytes)
